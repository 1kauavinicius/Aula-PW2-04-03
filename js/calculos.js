...
//isNaN verifica se é nulo ou não
//parseFloat Aceita números decimais
//topfixed é utilizado para formatar um número, definindo uma quantidade específica de casas decimais e retornando o resultado como uma string
//$("txtresultado") irá receber o resultado do txtresultado
...
$("#txtresultado")
       ...
       .html("Valor Final " + resultado + "<br> Moeda" 
        + moeda)
       .css({
        'font-weight' : 'bold', 
        'font-size' : '20px', 
       ...
       if(resultado > 5){
        alert("Valor maior que 5 Resenha");
